...
//Route::name('StubModuleNamePlural.')
//    ->middleware(['locale', 'auth', 'web'])
//    ->prefix('{lang}/StubModuleNamePlural')
//    ->group(function () {
////        Route::get('/', StubModuleNamespace\StubClassNamePrefix\Livewire\StubClassNamePrefixTable::class)
////            ->name('index');
//    });
